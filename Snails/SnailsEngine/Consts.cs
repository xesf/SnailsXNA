...
namespace TwoBrainsGames.Snails
{
    ...
    public class Colors   
    {
        ...
        public static Color ThemeSelectionScrBkColor = new Color(195, 110, 250); //Purplish
        public static Color CreditsScrBkColor = new Color(240, 160, 120);
    ...
    class GlobalCacheKeys
    {
        ...
        public const string MESSAGE_BOX_MESSAGE = "MESSAGE_BOX_MESSAGE";
        public const string STAGE_START_SCREEN_CALLER = "STAGE_START_SCREEN_CALLER";

        // Leaderboards remote calls
        public const string RPC_PARAM = "RPC_PARAM";
        public const string RPC_METHOD = "RPC_METHOD";
