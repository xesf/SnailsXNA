...
namespace TwoBrainsGames.Snails.StageObjects
{
    public class LaserBeamMirror : MovingObject, ISnailsDataFileSerializable, ICursorInteractable, IRotationControllable
    {
        ...
        public override void Draw(bool shadow)
        {
            if (!shadow)
            {
                this._mirrorSprite.Draw(this._mirrorReflectorPosition, 0, this.MirrorRotation + this.Rotation, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, Stage.CurrentStage.SpriteBatch);
            }
            else
            {
