...
namespace TwoBrainsGames.Snails.Screens
{
    class CreditsScreen : SnailsScreen
    {
        ...
        //UICreditsPanel _pnlBetaTesters;
        ...
        UISpriteFontLabel _versionAndContact;
        ...
        public override void OnLoad()
        {
            ...
            this.OnInitializeFromContent += new UIControl.UIEvent(CreditsScreen_OnInitializeFromContent);
            this.OnAfterInitializeFromContent += new UIControl.UIEvent(CreditsScreen_OnAfterInitializeFromContent);
            ...
            // Closed Beta Testers
            /*this._pnlBetaTesters = new UICreditsPanel(this);
            this._pnlBetaTesters.AddCategory("CREDITS_TESTERS");
            this._pnlBetaTesters.AddName("Francisco Ferreira");
            this._pnlBetaTesters.AddName("Marisa David");
            this.Controls.Add(this._pnlBetaTesters);*/
            ...
            // Version and contact
            this._versionAndContact = new UISpriteFontLabel(this);
            this._versionAndContact.Margins.Left = 150f;
            this._versionAndContact.ParentAlignment = AlignModes.Left | AlignModes.Bottom;
            this._versionAndContact.Font = BrainGame.ResourceManager.Load<SpriteFont>("fonts/contactInfo");
            this._versionAndContact.Text = string.Format("Product version {0}, support contact {1}, (C) 2Brains Games 2013, all rights reserved", SnailsGame.Settings.GameVersion, SnailsGame.Settings.SupportContact);
            this.Controls.Add(this._versionAndContact);
        }
        ...
        /// 
        /// </summary>
        void CreditsScreen_OnInitializeFromContent(IUIControl sender)
        {
            this.PanelSpacing = this.GetContentPropertyValue<float>("panelSpacing", 0f);
            this.Column1Position = this.GetContentPropertyValue<float>("column1Position", 0f);
            this.Column2Position = this.GetContentPropertyValue<float>("column2Position", 0f);
            this.YPosition = this.GetContentPropertyValue<float>("yPosition", 0f);
        }

        /// <summary>
        /// 
        /// </summary>
        void CreditsScreen_OnAfterInitializeFromContent(IUIControl sender)
        {
            ...
            this._pnlAdditionaSoundEffects.Position = new Vector2(this._pnlAddLevelDesign.Left, _pnlAddLevelDesign.Bottom + this.PanelSpacing);
            ...
            switch (this.State)
            {
                /*       case CreditsScreen.ScreenState.ShowingPanels:
                        if (this._inputController.ActionAccept)
                        {
                            ...
                            this._pnlMusic.Visible = true;
                            this._pnlAddLevelDesign.Visible = true;
                            //this._pnlBetaTesters.Visible = true;
                            this._pnlSpecialThanks.Visible = true;
                            this._pnlTeam.Visible = true;
                            this._imgBrainsLogo.Visible = true;
                            this._title.Visible = true;
