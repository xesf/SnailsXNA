...
{
    class UILoadingTip : UIControl
    {
        const float TIP_LEFT_MARGIN = 200f;
        string [] HintMessagesRes = new string[7] { "MSG_HINT1", "MSG_HINT2", "MSG_HINT3", "MSG_HINT4", 
                                                    "MSG_HINT5", "MSG_HINT6", "MSG_HINT7" };
        ...
        public bool AvailableForCurrentLocale
        {
            get { return LanguageManager.Contains(HintMessagesRes[0]); }
        }
        public UILoadingTip (UIScreen screenOwner) :
            base(screenOwner)
        {
