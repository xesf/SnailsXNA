...
namespace TwoBrainsGames.Snails.Screens.CommonControls
{
    ...
    class UIFooterMessage : UIControl
    {
            ...
            base(screenOwner)
        {
            ...
            string assetFooterMessage = "fonts/footerMessage";
            if (SnailsGame.Settings.Platform == BrainSettings.PlaformType.WP7 ||
                SnailsGame.Settings.Platform == BrainSettings.PlaformType.iOS ||
                SnailsGame.Settings.Platform == BrainSettings.PlaformType.Andriod)
            {
                assetFooterMessage += "WP";
            }

            this._lblMessage.Font = BrainGame.ResourceManager.Load<SpriteFont>(assetFooterMessage);
