...
namespace LevelEditor.Controls
{
    public partial class BoardCtl : UserControl
    {
        ...
        private void SelectObjects(BoundingSquare bsSelection, bool multiple)
        {
            ...
            for (int i = this.Stage.Stage.Objects.Count - 1; i >= 0; i-- )
            {
                StageObject obj = this.Stage.Stage.Objects[i];
                //  Microsoft.Xna.Framework.Rectangle rc = obj.Sprite.GetFrameBoundingBox(0);
                //  BoundingSquare bs = obj.TransformCurrentFrameBB().ToBoundingSquare();
        ...
        void RefreshBoardSize()
        {
            ...
            this._grpBoard.HorizontalScroll.Value = 0;
