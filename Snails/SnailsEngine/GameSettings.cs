...
namespace TwoBrainsGames.Snails.Configuration
{
    public class GameSettings : BrainSettings, IDataFileSerializable
    {
        ...
        public bool ShowHowPlayInMainMenu;
        ...
        public PresentationType PresentationMode
        {
            get
            {
                if (this.PresentationModeString == "LD")
                {
                    return PresentationType.LD;
                }
        ...
        protected override void Initialize()
        {
            ...
            //this.ShowHowPlayInMainMenu = this.GetValue<bool>("ShowHowPlayInMainMenu", ConfigSectionType.Game);
