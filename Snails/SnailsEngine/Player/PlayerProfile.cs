...
namespace TwoBrainsGames.Snails.Player
{
    public class PlayerProfile : IDataFileSerializable
    {
        ...
        public string RemoteServicesUsername { get; set; }
        public string RemoteServicesPassword { get; set; }
        public bool WithRemoteServicesUser
        {
            get 
            {
                return (!string.IsNullOrEmpty(this.RemoteServicesUsername) &&
                        !string.IsNullOrEmpty(this.RemoteServicesPassword));
            }
        }
        ...
        public void InitFromDataFileRecord(DataFileRecord record)
        {
            ...
            this.RemoteServicesUsername = recordSettings.GetFieldValue<string>("remoteServicesUsername", null);
            this.RemoteServicesPassword = recordSettings.GetFieldValue<string>("remoteServicesPassword", null);
        ...
        public virtual DataFileRecord ToDataFileRecord(ToDataFileRecordContext context)
        {
            ...
            recordSettings.AddField("remoteServicesUsername", this.RemoteServicesUsername);
            recordSettings.AddField("remoteServicesPassword", this.RemoteServicesPassword);
