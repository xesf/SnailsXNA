...
namespace TwoBrainsGames.Snails.Stages.HUD
{
    class HUDItemWarpButton : HUDItem, ICursorInteractable
    {
        ...
        public override void Initialize(Vector2 position)
        {
            ...
            this._position = new Vector2(-10f + SnailsGame.ScreenRectangle.X, SnailsGame.ScreenHeight - 70f);
        ...
        public override void LoadContent()
        {
            ...
            this._size = new Vector2(this._spriteWarp.Frames[0].Rect.X, this._spriteWarp.Frames[0].Rect.Y);
        }
        ...
        {
            this._spriteWarp.Draw(this._position, BUTTON_FRAME_IDX,  spriteBatch);
