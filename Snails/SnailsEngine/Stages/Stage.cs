...
//        protected int _saveTimeMultiplier;
        ...
        public void StartupEnded()
        {
            ...
            this._state = StageState.Playing;
        ...
        public void Update(BrainGameTime gameTime)
        {
            ...
            if (this._state == StageState.Startup)
            {
    ...
    //        if (RenderTarget != null) // this will block all the next interations if we alredy got the frame buffer
        ...
        public void PauseGame()
        {
            ...
            if (!this.IsPaused)
            {
				...
				SnailsGame.AchievementRetryEnabled = true;
        ...
        public void ResumeGame()
        {
			...
			SnailsGame.AchievementRetryEnabled = false;
        }
        ...
        public static LevelStage GetLevelStageFromDataFileRecord(DataFileRecord stageRecord)
        {
            ...
            levelStage._goldMedalTime = stageRecord.GetFieldValue<TimeSpan>("goldMedalTime");
            levelStage._goldMedalScore = stageRecord.GetFieldValue<int>("goldMedalScore");
        ...
        public virtual void InitFromDataFileRecord(DataFileRecord stageRecord)
        {
            ...
            this.LevelStage.CustomStageFilename = null;
        ...
        public virtual DataFileRecord ToDataFileRecord(ToDataFileRecordContext context)
        {
            ...
            record.AddField("goldMedalTime", this.LevelStage._goldMedalTime);
            record.AddField("goldMedalScore", this.LevelStage._goldMedalScore);
