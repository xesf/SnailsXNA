...
namespace TwoBrainsGames.Snails.Stages
{
    ...
    public class Levels : IBrainComponent, ISnailsDataFileSerializable, IAsyncOperation
    {
        ...
        public const int TOTAL_NUM_STAGES = NUM_THEMES * MAX_NUMBER_STAGES_PER_THEME;
        #endregion
        ...
        public LevelStage GetNextStageInfo()
        {
            ...
            if (nextStage > MAX_NUMBER_STAGES_PER_THEME)
            {
                nextStage = 1;
                nextTheme = (ThemeType)((int)Levels.CurrentTheme + 1);
                if (nextTheme > ThemeType.ThemeD)
                {
        ...
        {
            if (this._stagesByTheme[(int)theme] == null)
            {
                return 0;
            }
            return (this._stagesByTheme[(int)theme].Count);
        }
        ...
        public void IncrementStage()
        {
            ...
            if (Levels.CurrentStageNr > MAX_NUMBER_STAGES_PER_THEME)
            {
        ...
        public Stage LoadStage(string stageId, Stage.StageLoadingContext loadingContext)
        {
            ...
            this._stage.LevelStage = levelStage;
            Levels.CurrentLevelStage = levelStage;
        ...
        {
            return (int)levelStage.ThemeId * MAX_NUMBER_STAGES_PER_THEME + levelStage.StageNr - 1; // -1 because its zero-based
        }
        ...
        public static int UnlockedStagesNeeded(ThemeType themeToUnlock, ThemeType theme)
        {
            switch (themeToUnlock)
            {
                ...
                case ThemeType.ThemeB:
                    ...
                    {
                        return 6; // Stages needed in "The Garden"
                    }
