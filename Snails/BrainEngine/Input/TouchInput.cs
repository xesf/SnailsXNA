...
namespace TwoBrainsGames.BrainEngine.Input
{
    public class TouchInput : GameComponent
    {
        ...
        public override void Update(GameTime gameTime)
        {
         ...
         /*   
            // Crashou aqui com um erro muito estranho
            // "This operation cannot be completed until TouchPanel.EnabledGestures is assigned"
            // Daí ter adicionado este if
            ...
            */
            while (TouchPanel.IsGestureAvailable)
            {
                ...
                {
					Vector2 p = gestureSample.Position;
					Vector2 p2 = gestureSample.Position2;

					Vector2 pOld = gestureSample.Position - gestureSample.Delta;
					Vector2 p2Old = gestureSample.Position2 - gestureSample.Delta2;
