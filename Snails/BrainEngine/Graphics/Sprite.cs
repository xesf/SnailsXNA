...
namespace TwoBrainsGames.BrainEngine.Graphics
{
    public class Sprite : IDataFileSerializable
    {
		...
		public void DrawFast(Vector2 position, int frame, Color color, SpriteBatch spriteBatch)
		{
			spriteBatch.Draw(_texture, position, _frames[frame].Rect, color, 0.0f, Vector2.Zero, 1.0f, SpriteEffects.None, 0.0f);
		}
