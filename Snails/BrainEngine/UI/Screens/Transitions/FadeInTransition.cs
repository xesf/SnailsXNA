...
namespace TwoBrainsGames.BrainEngine.UI.Screens.Transitions
{
    public class FadeInTransition : Transition
    {
        ...
        public override void Draw()
        {
            ...
            BrainGame.SpriteBatch.Begin(SpriteSortMode.Immediate, null, BrainGame.CurrentSampler, null, null, BrainGame.RenderEffect);
            BrainGame.DrawRectangleFilled(BrainGame.SpriteBatch, new Rectangle(0, 0, BrainGame.ScreenWidth, BrainGame.ScreenHeight), fadeColor);
