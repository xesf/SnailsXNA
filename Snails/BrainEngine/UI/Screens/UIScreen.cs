...
namespace TwoBrainsGames.BrainEngine.UI.Screens
{
    ...
    public class UIScreen : Screen, IUIControl
    {
        ...
        public void BeginDraw(BlendState blendState)
        {
            ...
            if (this.Mask != null)
            {
                this.SpriteBatch.Begin(SpriteSortMode.Immediate, blendState, BrainGame.CurrentSampler, this.Mask.State, null, BrainGame.RenderEffect);
            }
            else
            {
                this.SpriteBatch.Begin(SpriteSortMode.Immediate, blendState, BrainGame.CurrentSampler, null, null, BrainGame.RenderEffect);
            }
        }
        ...
        internal override void Draw()
        {
            if (this.BackgroundColor != Color.Transparent || this.BackgroundImage != null)
            {
                ...
                if (this.BackgroundColor != Color.Transparent)
                {
                    ...
                    this.SpriteBatch.Draw(UIScreen.ClearTexture, new Rectangle((int)this.PositionInPixels.X, (int)this.PositionInPixels.Y,
