    ...
    public class UITextFontLabel : UILabel
    {
        ...
        public override void Draw()
        {
            ...
            if (this.Font != null)
            {
                /*            if (this.DropShadow)
                            {
                                this.Font.DrawString(this.SpriteBatch, this.Text, this.AbsolutePositionInPixels + this.ShadowDistance, this.Scale, this.ShadowColor);
                            }
                            this.Font.DrawString(this.SpriteBatch, this.Text, this.AbsolutePositionInPixels, this.Scale, this.BlendColor);*/
