...
namespace TwoBrainsGames.BrainEngine
{
    public class BrainSettings
    {
        ...
        public enum PlaformType
        {
            ...
            Windows8RT = 0x400,
			PSMobile = 0x800,
            All = Windows | XBox | WP7 | MacOSX | Linux | iOS | iPhone | iPad  | Andriod | Windows8 | Windows8RT,
            WindowsXbox = Windows | XBox,
            MonoGame = MacOSX | Linux | iOS | iPhone | iPad | Andriod | PSMobile
        }
        ...
        public string RemoteServicesGameId;
        public string RemoteServicesAPIKey;
...
#elif PSMobile
			this.Platform = PlaformType.PSMobile;
#endif
        }
        ...
        protected virtual void Initialize()
        {
            ...
            this.UseLeaderboards = this.GetValue<bool>("UseLeaderboards", false, ConfigSectionType.Engine);
            ...
            this.RemoteServicesGameId = this.GetValue<string>("RemoteServicesGameId", ConfigSectionType.Engine);
            this.RemoteServicesAPIKey = this.GetValue<string>("RemoteServicesAPIKey", ConfigSectionType.Engine);            
