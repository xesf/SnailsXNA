...
namespace TwoBrainsGames.BrainEngine.Debugging
{
    class DebugItem : DrawableGameComponent
    {
        ...
        /// 
        /// </summary>
        public DebugItem(Game game, DebugInfo debugInfo, string caption, Vector2 position, SpriteFont font, Color color, object value, string formatString) :
            base(game)
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            { 
                ...
                {
                    text = string.Format(this.StringFormat, this.Value);
                }
                else
                {
