...
namespace TwoBrainsGames.BrainEngine.UI.Controls
{
    ...
    public class UIControl : IUIControl
    {
        ...
        private void InitializeFromDataFileRecord()
        {
            ...
            this.Margins.Right = this.GetContentPropertyValue<float>("rightMargin", this.Margins.Right);
		...
		/// 
		/// </summary>
		protected Size FromNativeResolution(Size vector)
		{
			return new Size(vector.Width * (float)BrainGame.ScreenWidth / (float)BrainGame.NativeScreenWidth,
				vector.Height * (float)BrainGame.ScreenHeight / (float)BrainGame.NativeScreenHeight);
		}
