...
namespace TwoBrainsGames.Snails.StageObjects
{
    ...
    class RotationController: ICursorInteractable
    {
        ...
        private float Sensivity
        {
            get
            {
                return _sensivityBase * Stage.CurrentStage.Camera.Scale.X * Stage.CurrentStage.Camera.Scale.X;
            }
        }
        ...
        public void Initialize()
        {
            ...
            this._sensivityBase = (SnailsGame.GameSettings.PresentationMode == Configuration.GameSettings.PresentationType.HD ? SENSIVITY_HD : SENSIVITY_LD);
        ...
        public void CursorActionPressed(Vector2 cursorPos)
        {
            ...
            float offset = -(lengthMoved * this.Sensivity * dir);
