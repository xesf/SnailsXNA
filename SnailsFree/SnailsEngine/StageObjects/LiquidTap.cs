...
namespace TwoBrainsGames.Snails.StageObjects
{
    public class LiquidTap : LiquidSwitch, ISnailsDataFileSerializable
    {
        ...
        public bool SingleWay { get; set; }
        public TapOpenDirection SingleWorkingDirection { get; set; }
        ...
        public override void Copy(StageObject other)
        {
            ...
            this.SingleWay = ((LiquidTap)other).SingleWay;
            this.SingleWorkingDirection = ((LiquidTap)other).SingleWorkingDirection;
        }
        ...
        protected override void OnSnailCollided(Snail snail)
        {
            ...
            if (this.SingleWay)
            {
                if (snail.Direction == MovingObject.WalkDirection.Clockwise &
                    this.SingleWorkingDirection != TapOpenDirection.CounterClockwise)
                {
                    return;
                }
                if (snail.Direction == MovingObject.WalkDirection.CounterClockwise &
                    this.SingleWorkingDirection != TapOpenDirection.Clockwise)
                {
                    return;
                }
            }
        ...
        public override DataFileRecord ToDataFileRecord(ToDataFileRecordContext context)
        {
            ...
            record.AddField("singleWay", this.SingleWay);
            record.AddField("singleWorkingDirection", this.SingleWorkingDirection.ToString());
            return record;
        }
        ...
        public override void InitFromDataFileRecord(DataFileRecord record)
        {
            ...
            this.SingleWay = record.GetFieldValue<bool>("singleWay", this.SingleWay);
            this.SingleWorkingDirection = (TapOpenDirection)Enum.Parse(typeof(TapOpenDirection),
                                record.GetFieldValue<string>("singleWorkingDirection", this.SingleWorkingDirection.ToString()), true);
        }
