...
namespace TwoBrainsGames.Snails.StageObjects
{
    class ControllableLaserCannon : LaserCannonBase, ICursorInteractable, IRotationControllable
    {
        ...
        public enum SwitchOffActionType
        {
            TurnOff,
            DisableController
        }
        ...
        public SwitchOffActionType SwitchOffAction { get; set; }
        #endregion
        ...
        {
            switch (this.SwitchOffAction)
            {
                case SwitchOffActionType.TurnOff:
                    base.SwitchOff();
                    break;
             
                case SwitchOffActionType.DisableController:
                    this._controllerDisabled = true;
                    break;
            }
        }
        ...
        public override DataFileRecord ToDataFileRecord(ToDataFileRecordContext context)
        {
            ...
            record.AddField("switchOffAction", this.SwitchOffAction.ToString());
            return record;
        }
        ...
        public override void InitFromDataFileRecord(DataFileRecord record)
        {
            ...
            this.SwitchOffAction = (SwitchOffActionType)Enum.Parse(typeof(SwitchOffActionType), record.GetFieldValue<string>("switchOffAction", this.SwitchOffAction.ToString()), true);
        }
