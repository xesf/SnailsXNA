...
namespace TwoBrainsGames.Snails.StageObjects
{
    public class Salt : MovingObject
    {
        ...
        {
            base.HintInitialize();
            this._spriteHotSpot = BrainGame.ResourceManager.GetSpriteTemporary("spriteset/trampoline", "HotSpot");
        }

        /// <summary>
        /// 
        /// </summary>
        public override void HintDraw(Color color)
        {
            base.HintDraw(color);
            this._spriteHotSpot.Draw(this.Position, 0, color, Stage.CurrentStage.SpriteBatch);
        }
