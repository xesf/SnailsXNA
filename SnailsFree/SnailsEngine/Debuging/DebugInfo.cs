...
{
    partial class DebugInfo : DrawableGameComponent
    {
        ...
        // Counters
        FPSCounter FPSCounter { get; set; }
        TimerCounter DrawPerformanceTimer { get; set; }
        TimerCounter UpdatePerformanceTimer { get; set; }
        ...
        Color Opacity { get; set; }
        Color Textcolor { get; set; }
        Color BackColor { get; set; }
        private bool DockStyleChanged { get; set; }
        bool Averaging;
        Rectangle Rect { get; set; }
        //DebugItem TreeObjCounts { get; set; }
            ...
            base(game)
        {
            ...
            this.DockStyle = DockType.LowerLeft;
            this.DockStyleChanged = true;
            this.Visible = true;
            this.Rect = new Rectangle((int)this.Position.X, (int)this.Position.Y, DebugInfo.WINDOW_WIDTH, DebugInfo.WINDOW_HEIGHT);
        ...
        protected override void LoadContent()
        {
            ...
            this.Game.Components.Add(new DebugItem(this.Game, this, "FPSCounter", new Vector2(10, 5), this.Font, this.Textcolor, this.FPSCounter));
        ...
        private void Reposition()
        {
            ...
            switch (this.DockStyle)
            {
                ...
                case DockType.UpperRight:
                    this.Position = new Vector2(SnailsGame.GameSettings.ScreenWidth - frameWidth - DebugInfo.MARGIN, DebugInfo.MARGIN);
                    break;

                case DockType.LowerRight:
                    this.Position = new Vector2(SnailsGame.GameSettings.ScreenWidth - frameWidth - DebugInfo.MARGIN,
                                                SnailsGame.GameSettings.ScreenHeight - frameHeight - DebugInfo.MARGIN);
                    break;
