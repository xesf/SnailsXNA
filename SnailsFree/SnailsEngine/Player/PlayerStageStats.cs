...
namespace TwoBrainsGames.Snails.Player
{
    ...
    public class PlayerStageStats : IDataFileSerializable
    {
        ...
        public void InitFromDataFileRecord(DataFileRecord record)
        {
            ...
            this.HintsTaken = record.GetFieldValue<int>("hintsTaken", 0);
            this.Completed = record.GetFieldValue<bool>("completed", false);
        }
        ...
        public DataFileRecord ToDataFileRecord(ToDataFileRecordContext context)
        {
            ...
            record.AddField("highscore", this._highscore);
            record.AddField("timesPlayed", this.TimesPlayed);
            record.AddField("hintsTaken", this.HintsTaken);
            record.AddField("completed", this.Completed);
            return record;
        }
