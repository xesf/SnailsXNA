    ...
    public partial class BaseComboBox : ComboBox
    {
        ...
        public virtual void LoadValues(object param)
        {
            ...
            switch (this.ComboType)
            {
                ...
                case ComboBoxType.LasrSwitchOffAction:
                    this.Items.Add(ControllableLaserCannon.SwitchOffActionType.TurnOff);
                    this.Items.Add(ControllableLaserCannon.SwitchOffActionType.DisableController);
                   break;
            }
        }
