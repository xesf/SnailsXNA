...
namespace TwoBrainsGames.Snails.StageObjects
{
    public partial class StageObject
    {
        ...
        {
            this.Draw(graphics, offsetx, offsety, cursorDragging, this.BlendColor);
        }

        /// <summary>
        /// 
        /// </summary>
        public void Draw(Graphics graphics, int offsetx, int offsety, bool cursorDragging, Microsoft.Xna.Framework.Color color)
        {
            ImageAttributes ia = new ImageAttributes();

            if (color != Microsoft.Xna.Framework.Color.White)
            {
                Microsoft.Xna.Framework.Vector4 v4 = color.ToVector4();
