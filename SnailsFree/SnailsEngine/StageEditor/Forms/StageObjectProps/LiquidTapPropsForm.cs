...
namespace TwoBrainsGames.Snails.StageEditor.Forms.StageObjectProps
{
    public partial class LiquidTapPropsForm : ObjectPropsBaseForm
    {
        ...
        protected override void OnSaveValues()
        {
            ...
            this.Tap.SingleWay = this._chkSingleOpen.Checked;
            this.Tap.SingleWorkingDirection = (LiquidTap.TapOpenDirection)this._cmbWorkingDir.SelectedIndex;
        }
        ...
        protected override void OnLoadValues()
        {
            ...
            this._chkSingleOpen.Checked = this.Tap.SingleWay;
            this._cmbWorkingDir.SelectedIndex = (int)this.Tap.SingleWorkingDirection;
        }
        ...
        /// 
        /// </summary>
        private void _chkSingleOpen_CheckedChanged(object sender, EventArgs e)
        {
            this.label.Enabled = this._chkSingleOpen.Checked;
        }
