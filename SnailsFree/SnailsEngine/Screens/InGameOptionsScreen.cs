...
namespace TwoBrainsGames.Snails.Screens
{
    class InGameOptionsScreen : SnailsScreen
	{
        ...
        public override void OnLoad()
        {
            ...
            this._mnuMain.AddMenuItem("MNU_ITEM_SOUND_SETTINGS", this.OptionsMenu_OnSoundSettings, 0, true);
            this._mnuMain.AddMenuItem("MNU_ITEM_HOW_TO_PLAY", this.OptionsMenu_OnHowToPlay, 0, false);
            ...
            this.OnInitializeFromContent += new UIControl.UIEvent(InGameOptionsScreen_OnInitializeFromContent);
            this.WithBlurEffect = true;
        }

        void _goldMedalPanel_OnAfterInitializeFromContent(IUIControl sender)
        {
        }

        void InGameOptionsScreen_OnInitializeFromContent(IUIControl sender)
        {
        }
        ...
        /// 
        /// </summary>
        private void Menu_OnSoundSettings(IUIControl sender)
        {
        }
