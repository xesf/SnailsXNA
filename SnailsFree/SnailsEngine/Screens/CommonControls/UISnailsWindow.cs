...
namespace TwoBrainsGames.Snails.Screens.CommonControls
{
    ...
    class UISnailsWindow : UIControl
    {
            ...
            base(screenOwner)
        {
            ...
            this._board.BoardImage.AcceptControllerInput = true;
            this._board.BoardImage.Controls.Add(this._btnClose);
        ...
        public override void InitializeFromContent()
        {
         ...
         //   this.InitializeFromContent("UISnailsWindow");
            ...
            {
                this._title.Position = new Vector2(0, -1400);
                this._title.Scale = new Vector2(0.8f, 0.8f);
                // <Properties presentationMode="LD" titlePosition="0, -1400" titleScale="0.8, 0.8"/>
            }
            else
            {
                this._title.Position = new Vector2(0, -1300);
                //  this._title.Scale = this.GetContentPropertyValue<Vector2>("titleScale", this._title.Scale);
                // <Properties presentationMode="HD" titlePosition="0, -1300"/>
            }
        }
