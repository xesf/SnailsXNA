    ...
    class UISnailsButton : UIControl
    {
            ...
            set
            {
                ...
                switch (this._buttonAction)
                {
                    ...
                    case ButtonActionType.Retry:
                        ...
                        break;
                    case ButtonActionType.No:
                        resource = "spriteset/button-icons/NoIcon";
                        break;
                    case ButtonActionType.Yes:
                        resource = "spriteset/button-icons/YesIcon";
                        break;
                }
            ...
            base(screenOwner)
        {
            ...
            switch (type)
            {
                ...
                case ButtonSizeType.Medium:
                    ...
                    break;
                case ButtonSizeType.YouTube:
                    this._btnButton.ImageResource = "spriteset/boards/YouTubeButton";
                    break;
            }
        ...
        public override void InitializeFromContent()
        {
         ...
         //   this.InitializeFromContent("screens", "UISnailsButton");
            ...
            {
                this.Caption1PositionSmall = new Vector2(0, 270);
                this.Caption2PositionSmall = new Vector2(0, 730);
                this.Caption1PositionMedium = new Vector2(0, 270);
                this.Caption2PositionMedium = new Vector2(0, 830);
            }
            else
            {
                this.Caption1PositionSmall = new Vector2(0, 150);
                this.Caption2PositionSmall = new Vector2(0, 450);
                this.Caption1PositionMedium = new Vector2(0, 150);
                this.Caption2PositionMedium = new Vector2(0, 550);
            }
            this.UpdateLabels();
        }
