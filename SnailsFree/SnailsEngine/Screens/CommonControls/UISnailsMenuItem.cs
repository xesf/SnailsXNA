...
namespace TwoBrainsGames.Snails.Screens.CommonControls
{
    class UISnailsMenuItem : UIMenuItem
    {
        ...
        bool BlendTextScaleWithParent { get; set; }
            ...
            base(ownerScreen, textResourceId, spriteFont)
        {
            ...
            this.OnAfterInitializeFromContent += new UIEvent(UISnailsMenuItem_OnAfterInitializeFromContent);
            if (allowsSelection)
            {
...
//            _itemShownSample.PlaySameEffectMinTime = 0;
        ...
        public override void InitializeFromContent()
        {
          ...
          //  this.InitializeFromContent("UISnailsMenuItem");
            if (SnailsGame.GameSettings.PresentationMode == Configuration.GameSettings.PresentationType.LD)
            {
                this.TextScale = new Vector2(1.2f, 1.2f);
                this.BlendTextScaleWithParent = true;
                // <Properties presentationMode="LD" textScale="1.2, 1.2" blendTextScaleWithParent="true"/>
            }
            else
            {
                this.TextScale = new Vector2(1f, 1f);
                this.BlendTextScaleWithParent = false;
                // <Properties presentationMode="HD" textScale="1, 1" blendTextScaleWithParent="false"/>
            }
        }
        ...
        /// 
        /// </summary>
        void UISnailsMenuItem_OnAfterInitializeFromContent(IUIControl sender)
        {
  //          this.TextScale = this.GetContentPropertyValue<Vector2>("textScale", Vector2.One);
    //        this.BlendTextScaleWithParent = this.GetContentPropertyValue<bool>("blendTextScaleWithParent", true);
        ...
        public virtual void Initialize()
        {
            ...
            this.ShowEffect = new SquashEffect(0.73f, 4.0f, 0.04f, this.BlendColor, UISnailsMenuItem.DEFAULT_SCALE);
            this.HideEffect = new PopOutEffect(new Vector2(1.2f, 1.2f), 6.0f, this.BlendColor, UISnailsMenuItem.DEFAULT_SCALE);
     ...
     //       _itemShownSample.Play();
        ...
        public virtual void Reset()
        {
            ...
            this.Label.BlendColor = Colors.MenuItem;
            this.Label.BlendScaleWithParent = this.BlendTextScaleWithParent;
            this.Effect = null;
