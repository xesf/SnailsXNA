...
namespace TwoBrainsGames.Snails.Screens.CommonControls
{
	class UIHowToPlayWindow : UISnailsWindow
	{
		...
		base(screenOwner)
		{
			...
			this._btnNext.Position = this.PixelsToScreenUnits(new Vector2(255, 0));
			...
			this._btnPrev.Position = this.PixelsToScreenUnits(new Vector2(70, 0));
			...
			this._infoSignImg.Position = this.PixelsToScreenUnits(new Vector2(10, 10));
		...
		void UIHowToPlayWindow_OnScreenStart(IUIControl sender)
		{
			...
			this._infoSignImg.Sprite = BrainGame.ResourceManager.GetSpriteStatic("spriteset/tutorial_with_images/InfoSign");     
