...
namespace TwoBrainsGames.Snails.Screens.CommonControls
{
    class UISnailsScrollablePanel : UIPanel
    {
        ...
        public new Color BackgroundColor
        {
            get
            {
                return this._pnlContainer.BackgroundColor;
            }
            set
            {
                this._pnlContainer.BackgroundColor = value;
            }
        }
        ...
        public UIPanel Footer
        {
            get { return this._pnlFooter; }
        }

        public float BottomMargin 
        {
            get { return this._panel.BottomMargin; }
            set { this._panel.BottomMargin = value; }
        }
            ...
            base(screenOwner)
        {
            ...
            this._panel.Size = new Size(sheetLength, sheetLength); // Make it square, don't matter orientation
			                                                       // Currect width/height eill be set later
            this._panel.OnScroll += new UIEvent(_panel_OnScroll);
            this._pnlContainer.Controls.Add(this._panel);

            // Footer
            this._pnlFooter = new UIPanel(screenOwner);
            this._pnlFooter.BackgroundColor = Color.Transparent;
            this._pnlFooter.ParentAlignment = AlignModes.Bottom;
            this._pnlFooter.Visible = false;
            this._pnlContainer.Controls.Add(this._pnlFooter);
           ...
           // this._imgPanelTop.Margins.Top = this._imgPanelTop.Height;
            ...
            switch (this._panel.Orientation)
            {
				case UIScrollablePanel.PanelOrientation.Horizontal:
					...
					float f = (this.Height + 400) * this._imgPanelTop.SizeInPixels.Height / this._imgPanelTop.Size.Height; 
						float scalex = f / (float)this._imgPanelTop.SizeInPixels.Height;
						this._imgPanelTop.Scale = new Vector2 (scalex, scalex);
						this._imgPanelBottom.Scale = new Vector2 (scalex, scalex);
					}
                ...
                case UIScrollablePanel.PanelOrientation.Vertical:
                    ...
                    {
                        this._arrowEnd.Margins.Bottom = this.BottomMargin;
                    }
					...
					{
						// O que se está a fazer aqui é calcular a scale para ficar com 4500 de tamanho
					float f = (this.Width + 400) * this._imgPanelTop.SizeInPixels.Width / this._imgPanelTop.Size.Width; 
						float scalex = f / (float)this._imgPanelTop.SizeInPixels.Width;
						this._imgPanelTop.Scale = new Vector2 (scalex, scalex);
						this._imgPanelBottom.Scale = new Vector2 (scalex, scalex);
					}
					    break;
	            ...
	            this._pnlFooter.Width = this.Width;
