...
namespace TwoBrainsGames.Snails.Screens.CommonControls
{
    class UILanguageMenu : UIControl
    {
            ...
            base(screenOwner)
        {
            ...
            this.OnScreenStart += new UIEvent(UILanguageMenu_OnScreenStart);
        }

        void UILanguageMenu_OnScreenStart(IUIControl sender)
        {
            this.Scale = this._menu.Scale;
            this._menu.BlendScaleWithParent = false;
        }
