...
namespace TwoBrainsGames.Snails.Screens.ThemeSelection
{
    ...
    {
		protected static Vector2 DEFAULT_SCALE = new Vector2(0.9f, 0.9f);
        ...
        public override bool Visible
        {
            ...
            set
            {
                ...
                if (this._pnlContainer != null)
                {
					...
					this._pnlContainer.RemoveCurrentEffect ();
				}
            }
        }
            ...
            base(screenOwner)
        {
			...
			this._imgTheme.Position = this.PixelsToScreenUnits(new Vector2(30f, 35f));
			...
			this._imgSmallLocker.Position = this.PixelsToScreenUnits(new Vector2(325, 40));
			...
			this._lblStagesUnlocked.Position = this._imgSmallLocker.Position + this.PixelsToScreenUnits(new Vector2(80, 35));
			...
			this._imgMedal.Position = this.PixelsToScreenUnits(new Vector2(325, 135));
			...
			this._lblGoldMedalsEarned.Position = this._imgMedal.Position + this.PixelsToScreenUnits(new Vector2(80, 35));
            this._pnlContainer.Controls.Add(this._lblGoldMedalsEarned);

            // Theme locker
            this._lockerImage = new UILocker(screenOwner);
			this._lockerImage.Position = this.PixelsToScreenUnits(new Vector2(480, 455));
			...
			this._lblToUnlock.Position = this.PixelsToScreenUnits(new Vector2(0, 135));
			...
			this._lblLockedInTrial.Position = this.PixelsToScreenUnits(new Vector2(0, 155));
			...
			this._lblGardenNeeded.Position = this._lblToUnlock.Position + this.PixelsToScreenUnits(new Vector2(0, 30));
			...
			this._lblEgyptNeeded.Position = this._lblGardenNeeded.Position + this.PixelsToScreenUnits(new Vector2(0, 30));
			...
			this._lblFactoryNeeded.Position = this._lblEgyptNeeded.Position + this.PixelsToScreenUnits(new Vector2(0, 30));
        ...
        public override void Show()
        {
			...
			//base.Show();
			if (this._pnlContainer.ShowEffect == null) {
				InvokeOnShow ();
			}
        }
...
//            this.AcceptControllerInput = true;
        ...
        public void Refresh()
        {
			...
			this._lblStagesUnlocked.Text = string.Format("{0}/{1}", unlockedStages, Levels._instance.GetStagesCountForTheme(this.ThemeId));

			int goldMedals = SnailsGame.ProfilesManager.CurrentProfile.PlayerStats.GetTotalMedalsForTheme(MedalType.Gold, this.ThemeId);
			this._lblGoldMedalsEarned.Text = string.Format("{0}/{1}", goldMedals, Levels._instance.GetStagesCountForTheme(this.ThemeId));
            ...
            if (this.Locked)
            {
				...
				this._lockerImage.Position = this.NativeResolution(new Vector2(2450, 880));
