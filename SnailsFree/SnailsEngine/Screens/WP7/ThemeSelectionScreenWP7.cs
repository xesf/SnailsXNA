...
{
    class ThemeSelectionScreenWP7 : SnailsScreen
    {
        enum ScreenState
        {
            ThemeSelection,
        ...
        public ThemeSelectionScreenWP7(ScreenNavigator navigator) :
            base(navigator)
        {
        }
        ...
        public override void OnLoad()
        {
            ...
            this.OnOpenTransitionEnded += new UIControl.UIEvent(ThemeSelectionScreenWP7_OnOpenTransitionEnded);
        }
        ...
        /// 
        /// </summary>
        void ThemeSelectionScreenWP7_OnOpenTransitionEnded(IUIControl sender)
        {
