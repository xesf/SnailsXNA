...
namespace TwoBrainsGames.Snails.Screens
{
    class MainMenuScreen : SnailsScreen
    {
        ...
        protected UISoundMenu _mnuSound;


#if DEBUG
        protected UIPanel _panelToggleAllStageUnlocked;
#endif
        #endregion
        ...
        public override void OnLoad()
        {
            ...
            // Load theme music
            if (SnailsGame.GameSettings.PlayThemeMusic)
            {
			...
			this._capPressAnyKey.Position = new Vector2(0, 7000);
            this._capPressAnyKey.TextResourceId = "LBL_PRESS_ANY_BUTTON";
			this._capPressAnyKey.BlendColor = new Color (112, 199, 255);
            ...
            // Stage selection
            if (SnailsGame.GameSettings.AllowContinueFromMainMenu)
            {
                this._itmStageSelection = this._mnuMain.AddMenuItem("MNU_ITEM_STAGE_SELECTION", this.MainMenu_OnThemeSelection, 0, false);
            }

            // How to play
            this._mnuMain.AddMenuItem("MNU_ITEM_HOW_TO_PLAY", this.MainMenu_OnHowToPlay, 0, false, this.ShowHowToPlayOption);
            
            if (SnailsGame.Settings.UseAchievements)
            {
                this._mnuMain.AddMenuItem("MNU_ITEM_AWARDS", this.OptionsMenu_OnAchievements, 0, false, true);
            }

            // Options
            if (SnailsGame.GameSettings.ShowOptionsInMainMenu)
            {
                this._mnuMain.AddMenuItem("MNU_ITEM_OPTIONS", this.MainMenu_OnOptions, 0);
            }

            
            this._mnuMain.AddMenuItem("MNU_ITEM_SOUND_SETTINGS", this.MainMenu_OnSoundSettings, 0);
...
#if DEBUG
            this._panelToggleAllStageUnlocked = new UIPanel(this);
            this._panelToggleAllStageUnlocked.Name = "_panelToggleAllStageUnlocked";
            this._panelToggleAllStageUnlocked.Position = new Vector2(0f, 0f);
            this._panelToggleAllStageUnlocked.Size = new Size(1500, 1700);
            this._panelToggleAllStageUnlocked.OnAccept += new UIControl.UIEvent(panelToggleAllStageUnlocked_OnAccept);
            this.Controls.Add(this._panelToggleAllStageUnlocked);
#endif
            ...
            this.OnAfterInitializeFromContent += new UIControl.UIEvent(MainMenuScreen_OnAfterInitializeFromContent);
        ...
        /// 
        /// </summary>
        void MainMenuScreen_OnAfterInitializeFromContent(IUIControl sender)
        {
        ...
        /// 
        /// </summary>
        void panelToggleAllStageUnlocked_OnAccept(IUIControl sender)
        {
         /*   SnailsGame.GameSettings.AllStagesUnlocked = !SnailsGame.GameSettings.AllStagesUnlocked;
            Sample sample;
            sample = BrainGame.ResourceManager.GetSampleTemporary(AudioTags.TOGGLE_ALL_STAGES_UNLOCKED);
            sample.Play();*/
        }
#endif
        /// <summary>
        ...
        public override void OnStart()
        {
            ...
            if (SnailsGame.ProfilesManager.CurrentProfile != null &&
                SnailsGame.GameSettings.AllowContinueFromMainMenu)
            {
        ...
        public override void OnUpdate(BrainGameTime gameTime)
        {
            ...
            if (SnailsGame.GameSettings.BackQuitsGameOnIntroPicture &&
                ...
                (this._mnuMain.Visible || this._capPressAnyKey.Visible))
            {
                this.QuitGame();
                return;
            }
        ...
        /// 
        /// </summary>
        private void MainMenu_OnHowToPlay(IUIControl sender)
        {
            this.DisableInput();
        ...
        /// 
        /// </summary>
        private void MainMenu_OnSoundSettings(IUIControl sender)
        {
            this.DisableInput();
            this._state = State.MusicToggle;
            this._mnuSound.Show();
        }
