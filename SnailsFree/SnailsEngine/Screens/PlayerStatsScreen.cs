...
namespace TwoBrainsGames.Snails.Screens
{
    class PlayerStatsScreen : SnailsScreen
    {
            ...
            base(owner, ScreenType.PlayerStats)
        {
            ...
            this._pnlAchievs.Visible = BrainGame.Settings.UseAchievements;
            ...
            this._btnClearTrophies.Visible = (SnailsGame.Settings.UseAchievements);
            ...
            this._btnAchievs.Visible =  (BrainGame.Settings.UseAchievements);
